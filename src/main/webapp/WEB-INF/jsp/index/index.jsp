...
<html ng-app="teste">
    <head>
        ...
        <script src="<c:url value="./resources/js/metodos.js"/>"></script>
    </head>
    <body ng-controller="objeto">
        ...
        <div ng-controller="testou">
            <button type="submit" ng-click="vai()" class="btn btn-info">Pronto</button>
        </div>
